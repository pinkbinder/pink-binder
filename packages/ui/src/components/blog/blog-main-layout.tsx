...
export function BlogMainLayout({
  ...
  return (
    <main class={cn('min-h-screen px-4', compactMobile ? 'pt-6 pb-12 sm:pt-8 md:py-16' : 'py-16')}>
      <div
        class={cn('mx-auto flex max-w-6xl flex-col', compactMobile ? 'gap-5 md:gap-10' : 'gap-10')}
      >
        <BlogSiteBrand
          landingUrl={landingUrl}
          blogHomeHref={linkBlogTitleToHome ? '/' : undefined}
          class={compactMobile ? 'gap-4 md:gap-6' : undefined}
