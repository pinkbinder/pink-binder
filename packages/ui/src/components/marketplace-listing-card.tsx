  ...
  return (
    ...
    >
      ...
      >
        {marketplaceLogoUrl ? (
          <span
            className="absolute top-1.5 right-1.5 z-10 flex h-7 w-7 items-center justify-center overflow-hidden rounded-full border border-pink-200/80 bg-white p-1 shadow-xs"
