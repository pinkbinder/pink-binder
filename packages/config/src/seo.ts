...
export const SPECIES_COLLECTIONS = {
  ...
  dogs: {
    slug: 'dogs',
    title: 'Dogs',
    description: 'Puppy and dog-inspired Pokémon for canine-loving collectors.',
    featuredSpecies: ['Fidough', 'Dachsbun', 'Snubbull', 'Granbull', 'Greavard'],
  },
  cats: {
    slug: 'cats',
    title: 'Cats',
    description: 'Cat and kitten-inspired Pokémon that fit feline collector themes.',
    featuredSpecies: ['Skitty', 'Delcatty', 'Sprigatito', 'Mew', 'Meowstic'],
  },
  bunny: {
    slug: 'bunny',
    title: 'Bunny',
    description: 'Rabbit and bunny-themed Pokémon with soft, playful aesthetics.',
    featuredSpecies: ['Buneary', 'Lopunny', 'Azumarill', 'Minccino', 'Scorbunny'],
  },
  mice: {
    slug: 'mice',
    title: 'Mice',
    description: 'Mouse and small rodent-inspired Pokémon, including fan-favorite mascot lines.',
    featuredSpecies: ['Pichu', 'Pawmi', 'Dedenne', 'Tandemaus', 'Maushold'],
  },
  'all-other-animals': {
    slug: 'all-other-animals',
    title: 'All Other Animals',
    description: 'A broad animal mix including penguins, seals, giraffes, cows, bears, and more.',
    featuredSpecies: ['Piplup', 'Spheal', 'Girafarig', 'Miltank', 'Teddiursa'],
  },
  'dreamy-and-ethereal': {
...
const SPECIES_KEYWORD_SEEDS: SpeciesKeywordConfig[] = [
  ...
  },
  {
    ...
    name: 'Marill',
    collection: 'pink-pastel-icons',
    extraCollections: ['bunny', 'all-other-animals'],
